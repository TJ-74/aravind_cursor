...
export default function Contact() {
  ...
  return (
    <section id="contact" className="theme-section relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {/* Contact Form */}
          <div className="theme-card bg-[#151825]/50 backdrop-blur-sm rounded-3xl p-8 md:p-10">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  <option value="" className="bg-[#1a1d2d] text-gray-400">Select a service</option>
                  <option value="video-editing" className="bg-[#1a1d2d]">Video Editing</option>
                  <option value="motion-graphics" className="bg-[#1a1d2d]">Motion Graphics</option>
                  <option value="color-grading" className="bg-[#1a1d2d]">Color Grading</option>
                  <option value="sound-design" className="bg-[#1a1d2d]">Sound Design</option>
                  <option value="social-media" className="bg-[#1a1d2d]">Social Media Content</option>
                  <option value="post-production" className="bg-[#1a1d2d]">Post-Production</option>
                </select>
              </div>
          ...
          <div className="space-y-8">
            {/* Contact Cards */}
            <div className="theme-card bg-[#151825]/50 backdrop-blur-sm rounded-3xl p-8">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 w-12 h-12 theme-gradient rounded-lg flex items-center justify-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400">hello@videoedit.com</p>
                  <p className="text-gray-400">support@videoedit.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="theme-card bg-[#151825]/50 backdrop-blur-sm rounded-3xl p-8">
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <p className="mb-6 text-gray-300">Stay connected on social media</p>
                  <div className="flex space-x-4">
                    <a href="#" className="w-12 h-12 theme-gradient rounded-lg flex items-center justify-center transition-all hover:scale-110">
